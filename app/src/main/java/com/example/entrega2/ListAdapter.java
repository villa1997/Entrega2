...
public class ListAdapter extends BaseAdapter {
    Context contexto;
    String [] nombres, mensajes, horaUltimoMensaje, cuerpoMensajes;
    int[] idImagen;
    LayoutInflater inflater;

    public ListAdapter(Context contexto, String[] nombres, String[] mensajes, String[] horaUltimoMensaje, int[] idImagen, String[] cuerpoMensaje) {
        this.contexto = contexto;
        this.nombres = nombres;
        this.mensajes = mensajes;
        this.horaUltimoMensaje = horaUltimoMensaje;
        this.idImagen = idImagen;
        this.cuerpoMensajes = cuerpoMensaje;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        TextView cuerpoMensaje = view.findViewById(R.id.cuerpoMensaje);
        ...
        cuerpoMensaje.setText(cuerpoMensajes[i]);
